 ...
 * Programa para cadastrar duas cartas do jogo Super Trunfo
 * com informações sobre cidades.
 */
 ...
 int main() {
     ...
     char estado1;
     char codigo1[4];  // Array para armazenar código (ex: A01)
     ...
     scanf(" %[^\n]", cidade1);  // Permite ler nomes com espaço
